...
@Autonomous(name = "BatTech Auto Basket Vermelho", group = "AutoVermelho")
public class AutoVermelhoBasket extends PedroOpMode {

    public AutoVermelhoBasket() {
    ...
    private final Pose startPose = new Pose(144 - 9, 104, Math.toRadians(90));

    private final double xBasket = 144 - 17.700;
    private final double yBasket = 127.300;

    private final double xSample = 144 - 25.500;
    ...
    public void buildPaths() {
        ...
        depositarSampleUm = new Path(
                new BezierCurve(
                        new Point(144 - 9.000, 104.000, Point.CARTESIAN),
                        new Point(144 - 18.500, 113.500, Point.CARTESIAN),
                        new Point(xBasket, yBasket, Point.CARTESIAN)
                )
        );
        depositarSampleUm.setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(135));
        ...
        pegarSampleDois.setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180));
        ...
        pegarSampleQuatro = new Path(
                new BezierLine(
                        new Point(xBasket, yBasket, Point.CARTESIAN),
                        new Point(144 - 32.500, 124.500, Point.CARTESIAN)
                )
        );
        pegarSampleQuatro.setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(135 - 90)); // 45°
        ...
        depositarSampleQuatro.setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(135));
    }
